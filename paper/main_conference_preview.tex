...
\title{\vspace{-1.5em}Selective Query-Side Expansion for Agent Memory Retrieval:\\A Multi-Seed Study of Cost and Gate Reliability}
...
8 independently rebuilt memory-index seeds (4,000 query-memory pairs), SQE produces only a
small Recall@5 difference relative to dense retrieval; the Recall@5 difference against dense retrieval is 0.9 points with a 95\% interval of [0.1, 1.7]. It
expands 46.0\% of seed-42 queries, but does not clearly outperform a random
...
\begin{figure*}[!tbp]
\centering
\includegraphics[width=0.86\textwidth]{figures/method_overview.png}
...
In the seed-42 run, SQE changes Recall@5 by 0.0 percentage points relative to dense-only
retrieval and +0.0 percentage points relative to hybrid RRF
...
\begin{figure*}[!tbp]
\centering
\includegraphics[width=0.86\textwidth]{figures/recall_at_5.png}
...
\begin{figure*}[!tbp]
\centering
\includegraphics[width=0.86\textwidth]{figures/gate_diagnostic.png}
...
\begin{figure*}[!tbp]
\centering
\includegraphics[width=0.86\textwidth]{figures/threshold_sensitivity.png}
