...
\title{\vspace{-1.5em}Selective Query-Side Expansion for Long-Horizon Agent Memory Retrieval}
\author{Salomon DIEI\\School of Computer Science and Engineering, KOREATECH\\Presented at \href{https://sites.google.com/view/nafsik?pli=1\&authuser=0}{NAFSIK 2026}\\\texttt{salomon@koreatech.ac.kr}}
\date{}
...
\begin{table*}[!tbp]
\caption{Experiment configuration and public release links.}
\label{tab:setup}
\centering
\scriptsize
...
and the companion dataset is available at
