...
- `results/tokenmeasured_seed42/` contains executed cost measurements for
...
- `docs/audits/PASS1_RESULTS_SCHEMA.md` is documentation only; it is not Pass@1 evidence.
...
- `Random-Gated-Expansion` means the executed random-gating budget control
  stored in `results/seed*/random_budget_detailed.jsonl`.
