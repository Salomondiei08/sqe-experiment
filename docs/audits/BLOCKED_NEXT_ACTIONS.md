...
`docs/audits/SUBMISSION_READINESS.json` tracks this document as `Documented unblock steps`
...
- `docs/audits/SUBMISSION_READINESS.json` no longer marks downstream Pass@1/task-success
  as missing.
...
- `docs/audits/SUBMISSION_READINESS.json` no longer marks human-audited query quality
  labels as missing.
