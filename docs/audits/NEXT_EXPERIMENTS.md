...
top-conference empirical submission. `docs/audits/SUBMISSION_READINESS.json` lists the
...
- `results/gate_calibration/gate_feature_diagnostics.json`
...
- `results/gate_calibration/learned_gate_validation.json`
- `results/gate_calibration/learned_gate_detailed.jsonl`
...
- `docs/audits/SUBMISSION_READINESS.json`, check
...
- Do not claim Pass@1, human-label rates, or stronger gate performance until
  the corresponding verifier passes and `docs/audits/SUBMISSION_READINESS.json` reflects
  the new evidence.
