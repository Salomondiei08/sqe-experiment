...
`/home/nlp-07/sqe_experiment/results/seed42`
...
`results/multiseed/multiseed_report.json` and
...
- Directory: `results/tokenmeasured_seed42`
...
- `scripts/06_make_paper_artifacts.py`
  ...
  - Defaults to `results/seed42/` so direct runs use the active
...
- `scripts/15_gate_variant_diagnostics.py`
  ...
  - Produces `results/gate_calibration/gate_variant_diagnostics.json` and
    `paper/tables/gate_variant_diagnostics.tex`.
- `scripts/19_win_loss_analysis.py`
  ...
  - Produces `results/multiseed/win_loss_analysis.json` and
    `paper/tables/win_loss_analysis.tex`.
- `scripts/22_gate_feature_diagnostics.py`
  ...
  - Produces `results/gate_calibration/gate_feature_diagnostics.json` and
...
- `scripts/29_cross_seed_top1_gate.py`
  - Selects a top-1-score threshold on two independent memory-index seeds and
    ...
    Always-Expand rows.
  - Produces `results/gate_calibration/cross_seed_top1_gate.json` and
    `paper/tables/cross_seed_top1_gate.tex`.
